...
#            "#{$1}[= #{$3} #{$2} =] #{$4}"
  ...
  def createExtraVariablesForWid(wid, symbolHash, get_location)
    ...
    variables = {
      ...
      'latdatapad5' => sprintf("%8.5f", cache['latdata'] || 0.0),
      'londatapad5' => sprintf("%8.5f", cache['londata'] || 0.0),
      'latdatapad6' => sprintf("%9.6f", cache['latdata'] || 0.0),
      'londatapad6' => sprintf("%9.6f", cache['londata'] || 0.0),
