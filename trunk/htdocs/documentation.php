...
<? include("header.inc"); ?>
<div class="hacktext"> 
        <div class="hackpagetitle">Documentation (from README.txt)</div>

	<pre>
==========================================
GeoToad 3.5.0 by Thomas Stromberg (c) 2003
==========================================
...
Other Operating Systems -  You may need to install Ruby before running
GeoToad.
